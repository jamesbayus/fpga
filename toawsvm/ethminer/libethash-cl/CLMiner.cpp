...
bool CLMiner::initEpoch_internal()
{
    ...
    cout << endl << "generation done" << endl;
        ...
        {            
            ...
            try
            {
                ...
                if (kernel_file.good())
                {
                    ...
                    cout << "before seccess of build" << endl;
                    /* Setup the program */
	...
	uint32_t start;
        ...
        cout << endl << "Test " << workItems - chunk << endl;
